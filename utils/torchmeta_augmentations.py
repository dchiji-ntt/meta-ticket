# Based on https://github.com/tristandeleu/pytorch-meta/blob/master/torchmeta/transforms/augmentations.py
...
class Rotation(object):
    ...
    def __iter__(self):
        return iter(Rotation(angle, expand=self.expand,
    ...
    def __call__(self, image):
        ...
        return F.rotate(image, self.angle % 360, expand=self.expand, center=self.center, fill=fill)
