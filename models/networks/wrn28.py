# This code is based on https://github.com/learnables/learn2learn/blob/master/learn2learn/vision/models/wrn28.py
# Modification:
#   - add widen_factor option
#   - add track_running_stats=False
...
class wide_basic(torch.nn.Module):
    ...
    def __init__(self, in_planes, planes, dropout_rate, stride=1):
        ...
        self.bn1 = torch.nn.BatchNorm2d(in_planes, track_running_stats=False)
...
class WideResNet(torch.nn.Module):
    ...
    def __init__(self, depth, widen_factor, dropout_rate):
        ...
        self.bn1 = torch.nn.BatchNorm2d(nStages[3], momentum=0.9, track_running_stats=False)
...
class WRN28Backbone(WideResNet):
    ...
    def __init__(self, widen_factor, dropout=0.0):
...
class WRN28(torch.nn.Module):
    ...
    **Example**
    ...
    def __init__(
        ...
        self.features = WRN28Backbone(widen_factor, dropout=dropout)
        self.classifier = torch.nn.Linear(int(hidden_size * (widen_factor / 10)), output_size)
